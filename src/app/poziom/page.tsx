      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-sm border border-slate-100 mb-8 text-center relative overflow-hidden">
          <h1 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
            Ankieta Rozpoznawcza: Potrzeby & Cele
          </h1>
          <p className="mt-2 text-sm sm:text-base text-slate-600 max-w-xl mx-auto leading-relaxed font-medium">
            Krótka ankieta wstępna przed naszą 15-minutową rozmową zapoznawczą.
          </p>
          ...
          <div className="mt-6 p-4 rounded-2xl bg-brand-50/80 border border-brand-200/80 text-brand-900 text-xs sm:text-sm text-left flex items-start gap-3">
            ...
            <p className="leading-relaxed font-medium">
              <strong>Jak to działa?</strong> Nie oceniam tu Twojego poziomu ani nie wystawiam stopni. Ankieta służy temu, abym przed naszą darmową 15-minutową rozmową wiedziała: co już umiesz, z czym masz trudności, co chcesz powtórzyć od zera i na czym chcesz się skupić podczas naszej współpracy! 😊
            </p>
          </div>
